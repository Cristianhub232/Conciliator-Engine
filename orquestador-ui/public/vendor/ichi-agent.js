...
(function () {
  ...
  var CSS = [
    ...
    '.bub{max-width:330px;padding:12px 15px;border:1px solid #E1E7EE;border-radius:12px 12px 12px 3px;background:#fff}',
    '.row.user .bub{border-color:#0E2452;border-radius:12px 12px 3px 12px;background:#0E2452}',
    '.bub p{margin:0;font-size:14px;line-height:1.6;letter-spacing:-.005em;color:#26364E;text-wrap:pretty}',
