...
GRANT SELECT, UPDATE ON ORG_LIQ.LOTE TO ONT_SIR_BOT;
GRANT SELECT ON ORG_LIQ.FORMA_IMPUESTO TO ONT_SIR_BOT;

-- Privilegios en Esquema WFE_WORKFLOW
GRANT SELECT, INSERT, UPDATE ON WFE_WORKFLOW.WF_WORK_ITEM TO ONT_SIR_BOT;
GRANT SELECT, UPDATE ON WFE_WORKFLOW.WF_EXPEDIENTE TO ONT_SIR_BOT;
