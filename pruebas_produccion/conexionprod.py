...
def exportar_todos_esquemas(cursor):
    ...
    nombre_archivo = "detalles_todos_esquemas_prod.md"
    try:
        with open(nombre_archivo, "w", encoding="utf-8") as f:
            f.write("# Detalles de Objetos por Esquema (Producción SIGECOF)\n\n")
            current_owner = None
            current_type = None
    ...
    try:
        ...
        while True:
            ...
            if opcion == '1':
                ...
                esquema = input("Introduce el nombre del esquema (ej. SYSTEM): ").strip()
                if esquema:
